...
if ($changes -gt 0) {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "`n[!] Lỗi khi push lên GitHub." -ForegroundColor Yellow
    ...
    Write-Host "`n[i] Không có thay đổi mới, dữ liệu trên GitHub Pages đã là mới nhất." -ForegroundColor Cyan
    Write-Host " 🌐 Xem tại: https://sirlinh88.github.io/projects-dashboard/`n" -ForegroundColor Yellow
}